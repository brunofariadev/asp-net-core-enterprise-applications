...
namespace NSE.Pedido.Infra.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        public void Adicionar(Pedidoo pedido)
        {
            _context.Pedidos.Add(pedido);
        }

        public void Atualizar(Pedidoo pedido)
        {
        ...
        public async Task<IEnumerable<Pedidoo>> ObterListaPorClienteId(Guid clienteId)
        {
        ...
        public async Task<Pedidoo> ObterPorId(Guid id)
        {
